  ...
  return (
    <main className="shell">
      ...
      >
        <video
          className="bgVideo"
          src="/bloody-mary-bg.mp4"
          poster="/bloody-mary-poster.jpeg"
          autoPlay
          loop
          muted
          playsInline
        ...
        <div className="heroGrid">
          <div className="heroColLeft">
            <div className="indexBadge">
              <span className="indexNum">04</span>
              <span className="indexLabel">Bloody Mary</span>
            </div>
            <div className="heroCopy">
              <p>
                ...
                <br />
                boldest public crowds.
              </p>
            </div>
            <div className="heroMeta">
              <div className="metaItem">
                <span className="metaKey">Service</span>
                <span className="metaVal">Festival Hosting</span>
              </div>
              <div className="metaItem">
                <span className="metaKey">Access</span>
                <span className="metaVal">Public Scale</span>
              </div>
              <div className="metaItem">
          ...
          <div className="heroColCentre">
            <div className="titleBlock">
              <span className="titleEye">Festivals by</span>
              <div className="titleWrap">
                <h1 className="titleMain">
                  <span className="titleWord">BloodyMary</span>
      ...
      <footer className="footer">
        ...
        <span className="footerCentre">Grinding social spice to your public events</span>
        <span className="footerRight">bloodymary.tib</span>
      </footer>
    </main>
  );
}
