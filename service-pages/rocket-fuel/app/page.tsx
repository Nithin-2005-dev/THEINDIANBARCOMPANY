  ...
  return (
    <main className="shell">
      ...
      >
        <video
          className="bgVideo"
          src="/rocket-fuel-bg.mp4"
          poster="/rocket-fuel-poster.jpeg"
          autoPlay
          loop
          muted
          playsInline
        ...
        <div className="heroGrid">
          <div className="heroColLeft">
            <div className="indexBadge">
              <span className="indexNum">05</span>
              <span className="indexLabel">Rocket Fuel</span>
            </div>
            ...
            <div className="heroMeta">
              <div className="metaItem">
                ...
                <span className="metaVal">Night Launches</span>
              </div>
              <div className="metaItem">
                <span className="metaKey">Access</span>
                <span className="metaVal">After Dark</span>
              </div>
              <div className="metaItem">
          ...
          <div className="heroColCentre">
            <div className="titleBlock">
              <span className="titleEye">After Dark by</span>
              <div className="titleWrap">
                <h1 className="titleMain">
                  <span className="titleWord">RocketFuel</span>
      ...
      <footer className="footer">
        ...
        <span className="footerCentre">For the city after midnight</span>
        <span className="footerRight">rocketfuel.tib</span>
      </footer>
    </main>
  );
}
